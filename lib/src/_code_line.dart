...
class _CodeLineEditingControllerImpl extends ValueNotifier<CodeLineEditingValue>
  ...
  HashMap<int, List<CodeLineProblem>> _problems =
      HashMap<int, List<CodeLineProblem>>();

  @override
  HashMap<int, List<CodeLineProblem>> get problems => _problems;
  ...
  // @override
  // HashMap<int, List<CodeLineProblem>> problems =
  //     HashMap<int, List<CodeLineProblem>>();
}
...
class _CodeLineEditingControllerDelegate implements CodeLineEditingController {
  ...
  @override
  HashMap<int, List<CodeLineProblem>> get problems => _delegate.problems;

  @override
  set problems(HashMap<int, List<CodeLineProblem>> value) {
    _delegate.problems = value;
    notifyListeners();
  }
}

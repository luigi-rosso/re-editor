...
enum CodeLineProblemType {
  warning,
  error,
}

class CodeLineProblem {
  final int columnStart;
  final int columnEnd;
  final CodeLineProblemType type;
...
abstract class CodeLineEditingController
  ...
  set problems(HashMap<int, List<CodeLineProblem>> problems);
  HashMap<int, List<CodeLineProblem>> get problems;
